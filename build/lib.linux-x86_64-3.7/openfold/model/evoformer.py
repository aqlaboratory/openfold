...
class EvoformerBlockCore(nn.Module):
    ...
    def forward(self,
        ...
        # logging.warning(f"sachinkadyan7: EvoformerBlockCore chunk_size {chunk_size} _attn_chunk_size {_attn_chunk_size}")
...
class EvoformerBlock(nn.Module):
    ...
    def forward(self,
        ...
        del m, z
        # logging.warning(f"sachinkadyan7: EvoformerBlock chunk_size {chunk_size} _attn_chunk_size {_attn_chunk_size}")
        m, z = self.core(
            input_tensors,
            msa_mask=msa_mask, 
            pair_mask=pair_mask, 
...
class EvoformerStack(nn.Module):
    ...
    def _prep_blocks(self,
        ...
        # logging.warning(f"sachinkadyan7: EvoformerStack chunk_size {chunk_size}")
        blocks = [
            partial(
                b,
                msa_mask=msa_mask,
        ...
        if(chunk_size is not None and self.chunk_size_tuner is not None):
            ...
            # logging.warning(f"sachinkadyan7: EvoformerStack._prep_blocks chunk_size {chunk_size} "
            #                 f"_attn_chunk_size {max(chunk_size, tuned_chunk_size // 4)}")
            blocks = [
                partial(b,
    ...
    def _forward_offload(self,
        ...
        # logging.warning(f"sachinkadyan7: EvoformerStack._forward_offload() chunk_size {chunk_size}")
    ...
    def forward(self,
        ...
        """
        # logging.warning(f"sachinkadyan7: EvoformerStack.forward() chunk_size {chunk_size}")
        blocks = self._prep_blocks(
            m=m,
            z=z,
            chunk_size=chunk_size,
